...
#if DEV_BUILD_NOVA
            CmdTempRank.Delete(Player.Nova, args[0], Player.Nova.DefaultCmdData);
#else
...
#if DEV_BUILD_NOVA
            ModAction action = new ModAction(args[0], Player.Nova, ModActionType.Unfrozen, "auto unfreeze");
#else
...
#if DEV_BUILD_NOVA
            ModAction action = new ModAction(args[0], Player.Nova, ModActionType.Unmuted, "auto unmute");
#else
