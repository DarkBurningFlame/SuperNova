...
namespace SuperNova {
    ...
    public partial class Player : IDisposable {
        ...
        public Group group;
#if DEV_BUILD_NOVA
        public LevelPermission hideRank = LevelPermission.Nova;
#else
        ...
        public bool IsSuper;
#if DEV_BUILD_NOVA
        /// <summary> Whether this player is the Nova AI instance (Not fully implemented here yet, this is just for when 
        /// she finally is.)</summary>
