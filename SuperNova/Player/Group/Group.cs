...
namespace SuperNova {
    ...
    public sealed partial class Group {
        ...
        public string Name;
#if DEV_BUILD_NOVA
        [ConfigPerm("Permission", null, LevelPermission.Nova)]
        public LevelPermission Permission = LevelPermission.Nova;
#else
...
#if DEV_BUILD_NOVA
                Register(new Group(LevelPermission.Nova, int.MaxValue, int.MaxValue, "&5N&do&5v&da", '5'));
#else
